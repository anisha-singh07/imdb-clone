  ...
  return (
    <div className="movie">
            <div className="movieIntro">
                <img className="movieBackdrop" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail.backdrop_path : ""}`} />
            </div>
            <div className="movieDetail">
                <div className="movieDetailLeft">
                    <div className="moviePosterBox">
                        <img className="moviePoster" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail.poster_path : ""}`} />
                    </div>
                </div>
                <div className="movieDetailRight">
                    <div className="movieDetailRightTop">
                        <div className="movieName">{currentMovieDetail ? currentMovieDetail.original_title : ""}</div>
                        <div className="movieTagline">{currentMovieDetail ? currentMovieDetail.tagline : ""}</div>
                        <div className="movieRating">
                            {currentMovieDetail ? currentMovieDetail.vote_average: ""} <i class="fas fa-star" />
                            <span className="movieVoteCount">{currentMovieDetail ? "(" + currentMovieDetail.vote_count + ") votes" : ""}</span>
                        </div>  
                        <div className="movieRuntime">{currentMovieDetail ? currentMovieDetail.runtime + " mins" : ""}</div>
                        <div className="movieReleaseDate">{currentMovieDetail ? "Release date: " + currentMovieDetail.release_date : ""}</div>
                        ...
                        <>
                            {
                                ...
                                <span className="productionCompanyImage">
                                    <img className="movieProductionComapany" src={"https://image.tmdb.org/t/p/original" + company.logo_path} />
